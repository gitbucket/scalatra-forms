...
package object forms {
   ...
   */
  def withValidation[T](mapping: MappingValueType[T], params: Map[String, String], bundle: ResourceBundle)(action: T => Any): Any = {
    mapping.validate("", params, bundle).isEmpty match {
      case true  => action(mapping.convert("", params, bundle))
  ...
  trait ValueType[T] {
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle): T
    
    def validate(name: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)]
  ...
  abstract class SingleValueType[T](constraints: Constraint*) extends ValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle): T = 
      convert(params.get(name).orNull, bundle)
    
    def convert(value: String, bundle: ResourceBundle): T
    
    def validate(name: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = 
      validate(name, params.get(name).orNull, params, bundle)
    
    def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = 
      validaterec(name, value, params, Seq(constraints: _*), bundle)
    
    @scala.annotation.tailrec
    private def validaterec(name: String, value: String, params: Map[String, String], 
                             constraints: Seq[Constraint], bundle: ResourceBundle): Seq[(String, String)] = {
      constraints match {
        case (x :: rest) => x.validate(name, value, params, bundle) match {
          case Some(message) => Seq(name -> message)
          case None          => validaterec(name, value, params, rest, bundle)
        }
        case _ => Nil
      }
    }
  ...
  private class VerifyingValueType[T](valueType: ValueType[T], 
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle): T = valueType.convert(name, params, bundle)
        
    def validate(name: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = {
      val result = valueType.validate(name, params, bundle)
      if(result.isEmpty){
        validator(convert(name, params, bundle), params)
      } else {
        result
      }
    }
  ...
  abstract class MappingValueType[T] extends ValueType[T]{
    ...
    def validate(name: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] =
      fields.map { case (fieldName, valueType) => 
        valueType.validate((if(name.isEmpty) fieldName else name + "." + fieldName), params, bundle)
      }.flatten
    
    def validateAsJSON(params: Map[String, String], bundle: ResourceBundle): JObject = toJson(validate("", params, bundle))
  ...
  def text(constraints: Constraint*): SingleValueType[String] = new SingleValueType[String](constraints: _*){
    def convert(value: String, bundle: ResourceBundle): String = value
  }
  ...
  def boolean(constraints: Constraint*): SingleValueType[Boolean] = new SingleValueType[Boolean](constraints: _*){
    def convert(value: String, bundle: ResourceBundle): Boolean = value match {
  ...
  def number(constraints: Constraint*): SingleValueType[Int] = new SingleValueType[Int](constraints: _*){
    ...
    def convert(value: String, bundle: ResourceBundle): Int = value match {
      case null|"" => 0
      case x => x.toInt
    }
    
    override def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = {
      try {
        value.toInt
        super.validate(name, value, params, bundle)
      } catch {
  ...
  def double(constraints: Constraint*): SingleValueType[Double] = new SingleValueType[Double](constraints: _*){
    ...
    def convert(value: String, bundle: ResourceBundle): Double = value match {
      case null|"" => 0d
      case x => x.toDouble
    }
  ...
  def date(pattern: String, constraints: Constraint*): SingleValueType[java.util.Date] = 
    new SingleValueType[java.util.Date]((datePattern(pattern) +: constraints): _*){
      def convert(value: String, bundle: ResourceBundle): java.util.Date = new java.text.SimpleDateFormat(pattern).parse(value)
    }
  
  
  def mapping[T, P1](f1: (String, ValueType[P1]))(factory: (P1) => T): MappingValueType[T] = new MappingValueType[T]{
    def fields = Seq(f1)
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]))(factory: (P1, P2) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]))(factory: (P1, P2, P3) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]))(factory: (P1, P2, P3, P4) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]))(factory: (P1, P2, P3, P4, P5) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]))(factory: (P1, P2, P3, P4, P5, P6) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]))(factory: (P1, P2, P3, P4, P5, P6, P7) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]), f17: (String, ValueType[P17]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle), p(f17, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]), f17: (String, ValueType[P17]), f18: (String, ValueType[P18]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle), p(f17, name, params, bundle), p(f18, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]), f17: (String, ValueType[P17]), f18: (String, ValueType[P18]), f19: (String, ValueType[P19]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle), p(f17, name, params, bundle), p(f18, name, params, bundle), p(f19, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]), f17: (String, ValueType[P17]), f18: (String, ValueType[P18]), f19: (String, ValueType[P19]), f20: (String, ValueType[P20]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle), p(f17, name, params, bundle), p(f18, name, params, bundle), p(f19, name, params, bundle), p(f20, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]), f17: (String, ValueType[P17]), f18: (String, ValueType[P18]), f19: (String, ValueType[P19]), f20: (String, ValueType[P20]), f21: (String, ValueType[P21]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle), p(f17, name, params, bundle), p(f18, name, params, bundle), p(f19, name, params, bundle), p(f20, name, params, bundle), p(f21, name, params, bundle))
  }
  ...
  def mapping[T, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21, P22](f1: (String, ValueType[P1]), f2: (String, ValueType[P2]), f3: (String, ValueType[P3]), f4: (String, ValueType[P4]), f5: (String, ValueType[P5]), f6: (String, ValueType[P6]), f7: (String, ValueType[P7]), f8: (String, ValueType[P8]), f9: (String, ValueType[P9]), f10: (String, ValueType[P10]), f11: (String, ValueType[P11]), f12: (String, ValueType[P12]), f13: (String, ValueType[P13]), f14: (String, ValueType[P14]), f15: (String, ValueType[P15]), f16: (String, ValueType[P16]), f17: (String, ValueType[P17]), f18: (String, ValueType[P18]), f19: (String, ValueType[P19]), f20: (String, ValueType[P20]), f21: (String, ValueType[P21]), f22: (String, ValueType[P22]))(factory: (P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11, P12, P13, P14, P15, P16, P17, P18, P19, P20, P21, P22) => T): MappingValueType[T] = new MappingValueType[T]{
    ...
    def convert(name: String, params: Map[String, String], bundle: ResourceBundle) = factory(p(f1, name, params, bundle), p(f2, name, params, bundle), p(f3, name, params, bundle), p(f4, name, params, bundle), p(f5, name, params, bundle), p(f6, name, params, bundle), p(f7, name, params, bundle), p(f8, name, params, bundle), p(f9, name, params, bundle), p(f10, name, params, bundle), p(f11, name, params, bundle), p(f12, name, params, bundle), p(f13, name, params, bundle), p(f14, name, params, bundle), p(f15, name, params, bundle), p(f16, name, params, bundle), p(f17, name, params, bundle), p(f18, name, params, bundle), p(f19, name, params, bundle), p(f20, name, params, bundle), p(f21, name, params, bundle), p(f22, name, params, bundle))
  }
  
  private def p[T](field: (String, ValueType[T]), name: String, params: Map[String, String], bundle: ResourceBundle): T = 
    field match { case (fieldName, valueType) =>
      valueType.convert(if(name.isEmpty) fieldName else name + "." + fieldName, params, bundle)
    }
  ...
  def list[T](mapping: MappingValueType[T]): ValueType[List[T]] = new ValueType[List[T]](){
    ...
    override def convert(name: String, params: Map[String, String], bundle: ResourceBundle): List[T] = {
      ...
      (for(i <- 0 to max) yield {
        ...
        mapping.convert("", rowParams, bundle)
      }).toList
    }
    ...
    def validate(name: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = {
      ...
      (for(i <- 0 to max) yield {
        val rowParams = listParams.getOrElse(i, Map.empty[String, String])
        mapping.validate("", rowParams, bundle).map { case (key, message) =>
          (key + "_" + i, message)
        }
      }).flatten
    }
  ...
  def optional[T](valueType: SingleValueType[T]): SingleValueType[Option[T]] = new SingleValueType[Option[T]](){
    def convert(value: String, bundle: ResourceBundle): Option[T] = 
      if(value == null || value.isEmpty) None else Some(valueType.convert(value, bundle))
      
    override def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = 
      if(value == null || value.isEmpty) Nil else valueType.validate(name, value, params, bundle)
  }
  ...
  def optional[T](condition: (Map[String, String]) => Boolean, valueType: MappingValueType[T]): ValueType[Option[T]] = new ValueType[Option[T]](){
    override def convert(name: String, params: Map[String, String], bundle: ResourceBundle): Option[T] = 
      if(condition(params)) Some(valueType.convert(name, params, bundle)) else None
      
    override def validate(name: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = 
      if(condition(params)) valueType.validate(name, params, bundle) else Nil
  }
  ...
  def optionalRequired[T](condition: (Map[String, String]) => Boolean, 
    ...
    override def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] =
      required.validate(name, value, bundle) match {
        case Some(error) if(condition(params)) => Seq(name -> error)
        case Some(error) => Nil
        case None => valueType.validate(name, value, params, bundle)
      }
  }
  ...
  def trim[T](valueType: SingleValueType[T]): SingleValueType[T] = new SingleValueType[T](){
    ...
    def convert(value: String, bundle: ResourceBundle): T = valueType.convert(trim(value), bundle)
    
    override def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = 
      valueType.validate(name, trim(value), params, bundle)
  ...
  def label[T](label: String, valueType: SingleValueType[T]): SingleValueType[T] = new SingleValueType[T](){
    ...
    def convert(value: String, bundle: ResourceBundle): T = valueType.convert(value, bundle)
    
    override def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Seq[(String, String)] = 
      valueType.validate(label, value, params, bundle).map { case (label, message) => name -> message }
  ...
  trait Constraint {
    ...
    def validate(name: String, value: String, params: Map[String, String], bundle: ResourceBundle): Option[String] = validate(name, value, bundle)
    
    def validate(name: String, value: String, bundle: ResourceBundle): Option[String] = None
    
  }
  
  def required: Constraint = new Constraint(){
    override def validate(name: String, value: String, bundle: ResourceBundle): Option[String] = {
      if(value == null || value.isEmpty) Some(bundle.getString("error.required").format(name)) else None
    }
  }
  ...
  def maxlength(length: Int): Constraint = new Constraint(){
    override def validate(name: String, value: String, bundle: ResourceBundle): Option[String] =
      if(value != null && value.length > length) Some(bundle.getString("error.maxlength").format(name, length)) else None
  }
  
  def minlength(length: Int): Constraint = new Constraint(){
    override def validate(name: String, value: String, bundle: ResourceBundle): Option[String] =
      if(value != null && value.length < length) Some(bundle.getString("error.minlength").format(name, length)) else None
  }
  
  def pattern(pattern: String, message: String = ""): Constraint = new Constraint {
    override def validate(name: String, value: String, bundle: ResourceBundle): Option[String] =
      if(value != null && !value.matches("^" + pattern + "$")){
        if(message.isEmpty) Some(bundle.getString("error.pattern").format(name, pattern)) else Some(message)
      } else None
  }
      ...
      if(value != null && value.nonEmpty){
        try {
          ...
          case e: java.text.ParseException => 
            if(message.isEmpty) Some(bundle.getString("error.datePattern").format(name, pattern)) else Some(message)
        }
      } else None
  }  
